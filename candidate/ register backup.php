    ...
    <div>
         <div class="">
            <div class="animate form login_form">
                <section class="col-md-10 col-md-offset-1 line_design">
                    <form method="post" action="" id="basic_form"> 
                    <h1 class="text-center form_title">Registration Form</h1>
                      <div class="row">
                        ...
                        <div class="separator text-center">
                            ...
                            <div>
                                <h1><i class=""></i> TechInfini</h1>
                                <p>©2017 All Rights Reserved. TechInfini!</p>
                            </div>
                        </div>     
                    </form>    
                </section>
