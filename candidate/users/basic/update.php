      ...
      <div class="container col-lg-9">
        ...
        <div class="tab-content">
          ...
          <div id="Add-New" class="tab-pane fade in active">
            ...
            <form method="post" action="users/basic/update_logic.php" id="basic_form"> 
                  ...
                  <div class="row form-group">
                        ...
                        if(isset($_GET['tech_can_id'])){
                          ...
                          $expsql_result = mysqli_query($conn, $expsql);
                            ...
                            $company_ft = $row['tech_can_exp_nameofcompany'];
                            $designation_ft = $row['tech_can_exp_designation'];
                            $years_ft = $row['tech_can_exp_years'];
                            
                            $cop = json_decode($company_ft);
                            $des = json_decode($designation_ft);
                            $exp = json_decode($years_ft);
                        ...
                        <div class="col-lg-5">
                            ...
                            <input type="text" name="company_name_row[]" id="company_name_row[]" class="form-control" placeholder="Name of Company" maxlength="50" value="<?php echo $cop[$i]; ?>" /> 
                            </div>
                        </div>
                        <div class=" col-lg-4">
                            <div class="input-group exp-row">
                            <input type="text" name="designation_row[]" id="designation_row[]" class="form-control" placeholder="Designation" maxlength="50" value="<?php echo $des[$i]; ?>" /> 
                          </div>
                        </div>
                        <div class="col-lg-2 ">
                            <div class="input-group exp-row">
                            <input type="text" step="any" name="total_exp_row[]" title="Please enter valid year! example: 1 or 1.5" class="form-control" placeholder="Experience(Years)" value="<?php echo $exp[$i]; ?>" />
                            </div>
                        </div>
                        <?php if($i<=0){?>
                        <div class="col-sm-1">
                        ...
                        <div class="col-sm-1">
                            <div class="input-group-btn">
                                <button class="btn btn-danger" type="button" onclick="remove_education_fields();"> <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> </button>
                             </div>
                        </div>
                        <?php }?>
                        <?php }}?>
        ...
        <!--div 1 end-->
                  ...
                  <div class="col-lg-8">
                    <div class="row form-group ">
                      ...
                      <div class="input-group exp-row">
                        <input type="text" name="day_month" id="day_month" class="form-control" placeholder="Notice period (Day/Month)" maxlength="50" value="<?php echo $notice_fetch[0]; ?>" />
                      </div>
                      </div>
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-block btn-primary" name="btn_update">Update</button>
                </div>
