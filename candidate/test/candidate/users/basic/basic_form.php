          ...
          <div class="">
            <div class="form-group col-lg-4 exp-row">
              <div class="input-group ">
                ...
                <input type="text" name="user[name]" id="name" class="form-control" placeholder="Enter Name" required="" pattern="[a-zA-Z0-9 ]{3,}" title="Alphabets/Digits only! Please enter more than three letters" />
              </div>
            </div>
          ...
          <div class="">
            <div class="row form-group ">
              <div class="col-md-4 col-md-offset-5">
                <div class="input-group exp-row">
                  <input type="text" name="user[meta][notice_period]" id="day_month" class="form-control" placeholder="Notice period (Day/Month)" maxlength="50" required="" pattern="[0-9 ][0-9]" />
                </div>
              </div>
